...
class Button : UIButton {
    ...
    convenience init(icon: String, font: UIFont = UIFont.vxmarket(UIFont.systemFontSize), size: CGFloat = UIFont.systemFontSize, textColor: UIColor = UIColor.white) {
        self.init()
        titleLabel?.font = font
        titleLabel?.font = UIFont.vxmarket(size)
...
final class IconSegmentButton: Button {
    ...
    @IBInspectable var textSize: CGFloat = UIFont.systemFontSize
    ...
    override func awakeFromNib() {
        ...
        case .top:
            ...
            textLabel.snp.makeConstraints {
                $0.top.equalTo(iconLabel.snp.bottom).offset(5)
        ...
        case .right:
            ...
            iconLabel.snp.makeConstraints {
                ...
                $0.leading.equalTo(textLabel.snp.trailing).offset(5)
            }
        default:
            textLabel.snp.makeConstraints {
    ...
    private var iconLabel = Label(icon: "", size: 24, textColor: UIColor.lightGray)
...
extension UIFont {
    ...
    class func vxmarket(_ size: CGFloat) -> UIFont! {
        return UIFont(name: "vxmarket", size: size)
    }
}
